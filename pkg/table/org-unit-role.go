...
const (
	...
	// ResourceMatchCriteriaRegex disabled - may contradict with resource naming convention in feature services
)

// GetAvailableResourceMatchCriteria returns all available resource matching criteria
func GetAvailableResourceMatchCriteria() []ResourceMatchCriteria {
	return []ResourceMatchCriteria{
		ResourceMatchCriteriaAny,
		ResourceMatchCriteriaExact,
		ResourceMatchCriteriaPrefix,
		ResourceMatchCriteriaSuffix,
	}
}

func GetAvailableRolePermissionAction() []RolePermissionAction {
	return []RolePermissionAction{
		RolePermissionActionDeny,
		RolePermissionActionAllow,
	}
}
...
const (
	...
	// RolePermissionActionLog disabled for now
)
